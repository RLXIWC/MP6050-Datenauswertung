#ifndef _GEEKMUM_COMPLEMENT_FILTER_
#define _GEEKMUM_COMPLEMENT_FILTER_
...
inline unsigned long get_last_time_Sensor_2() { return last_read_time_Sensor_2; }
inline float get_last_x_angle_Sensor_2() { return last_x_angle_Sensor_2; }
inline float get_last_y_angle_Sensor_2() { return last_y_angle_Sensor_2; }
inline float get_last_z_angle_Sensor_2() { return last_z_angle_Sensor_2; }
inline float get_last_gyro_x_angle_Sensor_2() { return last_gyro_x_angle_Sensor_2; }
inline float get_last_gyro_y_angle_Sensor_2() { return last_gyro_y_angle_Sensor_2; }
inline float get_last_gyro_z_angle_Sensor_2() { return last_gyro_z_angle_Sensor_2; }

//  Use the following global variables and access functions
//  to calibrate the acceleration sensor
float base_x_gyro_Sensor_1;
float base_y_gyro_Sensor_1;
float base_z_gyro_Sensor_1;
float base_x_accel_Sensor_1;
float base_y_accel_Sensor_1;
float base_z_accel_Sensor_1;

float base_x_gyro_Sensor_2;
float base_y_gyro_Sensor_2;
float base_z_gyro_Sensor_2;
float base_x_accel_Sensor_2;
float base_y_accel_Sensor_2;
float base_z_accel_Sensor_2;
...
void calibrate_Sensor_1()
{
    ...
    base_x_accel_Sensor_1 = x_accel;
    base_y_accel_Sensor_1 = y_accel;
    base_z_accel_Sensor_1 = z_accel;
    base_x_gyro_Sensor_1 = x_gyro;
    base_y_gyro_Sensor_1 = y_gyro;
    base_z_gyro_Sensor_1 = z_gyro;
...
void calibrate_Sensor_2()
{
    ...
    // Store the raw calibration values globally
    base_x_accel_Sensor_2 = x_accel;
    base_y_accel_Sensor_2 = y_accel;
    base_z_accel_Sensor_2 = z_accel;
    base_x_gyro_Sensor_2 = x_gyro;
    base_y_gyro_Sensor_2 = y_gyro;
    base_z_gyro_Sensor_2 = z_gyro;

...
void loop()
{
    ...
    Serial.print("\t");
    Serial.print(euler_ergebnis[2] * 180 / M_PI);
    Serial.println();
    ...
    Serial.print(Acc_x_mean);
    Serial.print("\t");
    Serial.print(Acc_y_mean);
    Serial.print("\t");
    Serial.print(Acc_z_mean);
    Serial.print("\t");

    Serial.print(Gyro_x_mean);
    Serial.print("\t");
    Serial.print(Gyro_y_mean);
    Serial.print("\t");

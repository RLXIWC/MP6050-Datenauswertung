...
/* Titel: ATMega 2560 mit einem MPU6050 
*
* Version: v1.0
...
*
* Kurze Beschreibung:
* Auslesen eines Sensoren und testen des Drifts und Offsets
* Aufzeichnen der Ausgabe über Seriell Port mit CoolTerm und Diagramme zeichnen in Matlab
* 
*
* Ausgabe:
* Gyro und Acc Values
...
* 1x MPU6050 per I2C anschließen, VCC, GND, SCL an PIN 16, SDA an PIN 15 ((ATMega 2560)
* 
*
* Changelog:
* 
